      ...
      >
        ...
        <div className="px-2">
          <div className="flex justify-between items-center mb-6">
            <span className="text-[10px] font-bold tracking-widest text-gold uppercase px-3 py-1 bg-gold/5 border border-gold/20 rounded-full">
              {project.category}
            </span>
          </div>
          ...
          <div className="flex">
            <a
              ...
              className="btn-primary py-3.5 px-10 text-[10px] font-bold tracking-widest flex items-center gap-2 group/btn shadow-xl shadow-gold/10"
            >
              Live Demo
            ...
            {isTestimonialVisible ? (
              ...
              >
                ...
                <div className="flex gap-1.5 mt-4">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-3.5 h-3.5 fill-gold text-gold drop-shadow-[0_0_8px_rgba(212,175,55,0.4)]" />
                    ))}
                </div>

                {/* Ambient Glow */}
                <div className="absolute -inset-px bg-gradient-to-br from-gold/10 to-transparent rounded-[inherit] opacity-0 group-hover/testimonial:opacity-100 transition-opacity pointer-events-none" />
              </motion.div>
            ) : (
              <motion.button
